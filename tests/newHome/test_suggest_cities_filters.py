...
class TestSuggestedCityAndFilter:
    ...
    def atest_filter_suggested_city(self, config):
    ...
    def atest_filter_by_building_type(self, config):
    ...
    def atest_filter_checkin_time(self, config):
    ...
    def atest_filter_price(self, config):
